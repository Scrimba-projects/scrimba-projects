    ...
    return (
        <div className="card">
            ...
            <div className="card-details">
                <div>
                    <svg className="card-pin" width="7" height="10" viewBox="0 0 7 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a className="card-google" href={props.item.googleMapsUrl} target="_blank">View on Google Maps</a>
                </div>
                <h1 className="card-title">{props.item.title}</h1>
                <span className="card-period">{props.item.startDate} - {props.item.endDate}</span>
